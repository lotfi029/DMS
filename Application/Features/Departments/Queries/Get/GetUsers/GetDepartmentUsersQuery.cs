...
internal sealed class GetAllUsersQueryHandler(IDepartmentDomainService departmentDomainService) : IQueryHandler<GetDepartmentUsersQuery, List<UserListResponse>>
{
