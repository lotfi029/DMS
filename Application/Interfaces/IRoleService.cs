...
public interface IRoleService
{
    ...
    public Task<Result<IEnumerable<RoleListResponse>>> GetUserRolesAsync(string userId, CancellationToken ct = default);
    public Task<Result<IEnumerable<RoleListResponse>>> GetAllRolesAsync(CancellationToken ct = default);
    Task<Result> UserInRoleAsync(string userId, string roleId, CancellationToken ct = default);
    Task<Result<RoleResponse>> GetByIdAsync(string roleId, CancellationToken ct = default);
}
